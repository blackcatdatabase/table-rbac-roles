...
> Lineage: 1 outbound / 2 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\rbac-roles](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rbac-roles) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-roles -Apply
