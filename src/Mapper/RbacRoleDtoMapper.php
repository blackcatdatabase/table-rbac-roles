...
namespace BlackCat\Database\Packages\RbacRoles\Mapper;

use BlackCat\Database\Packages\RbacRoles\Dto\RbacRoleDto;
use BlackCat\Database\Packages\RbacRoles\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RbacRoleDto:
...
final class RbacRoleDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'repo_id', 'version' ];
    /** @var string[] */
     ...
     * @return RbacRoleDto
     */
    public static function fromRow(array $row): RbacRoleDto
    {
        /** @var RbacRoleDto */
    ...
    public static function fromRowOrNull(?array $row): ?RbacRoleDto
    {
     ...
     *
     * @param RbacRoleDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RbacRoleDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RbacRoleDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RbacRoleDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RbacRoleDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RbacRoleDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RbacRoleDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RbacRoleDto>
     */
