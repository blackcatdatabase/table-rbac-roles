...
namespace BlackCat\Database\Packages\RbacRoles;
...
use BlackCat\Database\Packages\RbacRoles\Repository\RbacRoleRepository as GeneratedRepository;
...
{
  private RbacRoleRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RbacRoleRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RbacRoleRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRoles\Dto\RbacRoleDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRoles\Dto\RbacRoleDto|null { return $this->repo->getById($id, $asDto); }
