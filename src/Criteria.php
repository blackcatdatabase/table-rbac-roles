...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'repo_id', 'slug', 'name', 'description', 'version', 'status', 'created_at', 'updated_at' ];
    }
    ...
    {
        $x = [ 'id', 'repo_id', 'slug', 'name', 'description', 'version', 'status', 'created_at', 'updated_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RbacRoles\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RbacRoles\Definitions::softDeleteColumn();
