...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rbac_roles'; }
    public static function contractView(): string { return 'vw_rbac_roles'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'repo_id', 'slug', 'name', 'description', 'version', 'status', 'created_at', 'updated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'repo_id', 'slug' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'repo_id', 'version' ]; }
